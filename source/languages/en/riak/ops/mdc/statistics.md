...
moved: {
    '1.4.0-': 'riakee:/cookbooks/Multi-Data-Center-Replication-Status',
    '1.4.0-2.0.0': 'riakee:/cookbooks/Multi-Data-Center-Replication-Statistics'
}
---
...
`client_stats` | See <a href="/ops/mdc/statistics/#Client-Statistics">Client Statistics</a>
`server_stats` | See <a href="/ops/mdc/statistics/#Server-Statistics">Server Statistics</a>
